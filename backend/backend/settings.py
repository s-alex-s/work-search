...
SECRET_KEY = 'django-insecure-)jwt17b*0q6cn-t%^9z!**e(n%5gyio(vfxual^&3wo7p*g2m-'
...
CSRF_TRUSTED_ORIGINS = [os.getenv('BACKEND_DOMAIN')]
...
DJOSER = {
    ...
    'USERNAME_RESET_CONFIRM_URL': 'account/username/reset/confirm/{uid}/{token}',
    'ACTIVATION_URL': 'account/activate/{uid}/{token}',
    'SEND_ACTIVATION_EMAIL': True,
    'SERIALIZERS': {},
    'CONSTANTS': {
        'messages': 'main.customDjoserMessages.Messages'
    },
